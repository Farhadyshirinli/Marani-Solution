...
namespace Marani.WebUI.Controllers
{
    public class AccountController : Controller
    {
        ...
        private readonly UserManager<MaraniUser> userManager;
        private readonly EmailService emailService;
        private readonly RoleManager<MaraniRole> roleManager;

        public AccountController(SignInManager<MaraniUser> signInManager, UserManager<MaraniUser> userManager, EmailService emailService, RoleManager<MaraniRole> roleManager)
        {
		...
		public async Task CreateRole()
        {
            ...
            {
                var userRole = new MaraniRole { Name = "User" };
